...
const data = [
  ...
  {
    baslik: "Yazılımcı olmanın altın kuralı",
    tarih: "22 Mart 2023",
    ilkParagraf: `Hodor hodor HODOR! Hodor hodor - hodor, hodor. Hodor hodor... Hodor hodor hodor; hodor hodor. Hodor hodor hodor, hodor, hodor
          hodor. Hodor, hodor. Hodor. Hodor, hodor - hodor... Hodor hodor hodor; hodor HODOR hodor, hodor hodor?! Hodor hodor, hodor.
          Hodor hodor hodor hodor hodor! Hodor hodor - HODOR hodor, hodor hodor hodor hodor hodor; hodor hodor? `,
...
function haberYapici(haberObj) {
  ...
  haberBaslik.textContent = haberObj.baslik;

  const haberParagraf = document.createElement("p");
  haberParagraf.classList.add("tarih");
  haberParagraf.textContent = haberObj.tarih;

  const paragraf1 = document.createElement("p");
  paragraf1.textContent = haberObj.ilkParagraf;

  const paragraf2 = document.createElement("p");
  paragraf2.textContent = haberObj.ikinciParagraf;

  const paragraf3 = document.createElement("p");
  paragraf3.textContent = haberObj.ucuncuParagraf;
  ...
  haberKutu.appendChild(haberParagraf);
  haberKutu.appendChild(paragraf1);
  haberKutu.appendChild(paragraf2);
  haberKutu.appendChild(paragraf3);
  haberKutu.appendChild(expandButton);

  body.appendChild(haberKutu);
...
data.map((haberler) => haberYapici(haberler));
